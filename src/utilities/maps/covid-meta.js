...
export const trs_json = [
  ...
  // end: 1,
  // trs_seq: null,
  // text: '5` end of the RNA sequence where transcription ends',
  // },
  {
  button_label: '5`-leader',
  start: 1,
  end: 63,
  trs_seq: null,
  ...
  {
  button_label: '3`-Transcription start',
  start: 29543,
  end: 29903,
  trs_seq: null,
...
export const geneBank_json = [
  ...
  // button_label: "5`",
  // type: 'u',
  // text: '5` end of the RNA sequence from which translation begins',
  // },
  {start: 1,
  end: 265,
  gene: "UTR",
  ...
  // button_label: "3`end",
  // type: 'u',
  // text: '3` end of the RNA sequence (including the poly A tail) where translation ends',
  // },
]
