...
export const trs_json = [
  ...
  trs_seq: null,
  text: 'RNA sequence included in all transcribed subgenomic copies that facilitate ribosome binding and translation of genes downstream of the polyprotein',
  },
  {
  button_label: 'T1',
  start: 64,
...
export const nsp_json = [
  ...
  cleavage: true,
  text: 'Cleavage site in the ab1/2 polyprotein which gives rise to the NSP proteins.',
  },
  {
  button_label: 'N2',
  nsp: 'NSP2',
  ...
  SW_true: true,
  product: 'Nsp3',
  note: 'Former nsp1; conserved domains are: N-terminal acidic (Ac), predicted phosphoesterase, papain-like proteinase, Y-domain, transmembrane domain 1 (TM1), adenosine diphosphate-ribose 1`-phosphatase (ADRP); produced by both pp1a and pp1ab',
  ...
  note: 'Nsp5A_3CLpro and nsp5B_3CLpro; main proteinase (Mpro); mediates cleavages downstream of nsp4. 3D structure of the SARSr-CoV homolog has been determined (Yang et al., 2003); produced by both pp1a and pp1ab',
  ...
  {
  button_label: '3`UTR',
  nsp: 'Region downstrean or Polyptotein, coding for S protein to ORF10 ',
  start: 29675,
  end: 29903,
  aa_res: null,
  cleavage: false,
